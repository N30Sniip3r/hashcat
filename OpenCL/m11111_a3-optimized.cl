...
static void m11111s (u32 *w, const u32 pw_len, KERN_ATTR_VECTOR ())
{
  /**
   * modifier
   */
...
__kernel void m11111_m04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
__kernel void m11111_m08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
__kernel void m11111_m16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
__kernel void m11111_s04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
  ...
  m11111s (w, pw_len, pws, rules_buf, combs_buf, words_buf_r, tmps, hooks, bitmaps_buf_s1_a, bitmaps_buf_s1_b, bitmaps_buf_s1_c, bitmaps_buf_s1_d, bitmaps_buf_s2_a, bitmaps_buf_s2_b, bitmaps_buf_s2_c, bitmaps_buf_s2_d, plains_buf, digests_buf, hashes_shown, salt_bufs, esalt_bufs, d_return_buf, d_scryptV0_buf, d_scryptV1_buf, d_scryptV2_buf, d_scryptV3_buf, bitmap_mask, bitmap_shift1, bitmap_shift2, salt_pos, loop_pos, loop_cnt, il_cnt, digests_cnt, digests_offset, combs_mode, gid_max);
}

__kernel void m11111_s08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
__kernel void m11111_s16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
